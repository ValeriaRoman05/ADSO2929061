...
// 2. Consulta para obtener los datos de la venta específica
$query_venta = "SELECT * FROM ventas WHERE id_venta = ?";
...
// 4. Consulta para obtener todos los productos
            ...
            <div class="grupo-formulario">
                ...
                <select id="id_cliente" name="id_cliente" required>
                    <?php while ($cliente = $clientes->fetch_assoc()) { ?>
                        <option value="<?php echo htmlspecialchars($cliente['id_cliente']); ?>" <?php echo ($venta['id_cliente'] == $cliente['id_cliente']) ? 'selected' : ''; ?>>
            ...
            <div class="grupo-formulario">
                ...
                <select id="id_producto" name="id_producto" required>
                    <?php while ($producto = $productos->fetch_assoc()) { ?>
                        <option value="<?php echo htmlspecialchars($producto['id_producto']); ?>" <?php echo ($venta['id_producto'] == $producto['id_producto']) ? 'selected' : ''; ?>>
