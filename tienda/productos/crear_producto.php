...
<head>
    ...
    <style>
        ...
        /* Estilos para el enlace de "Ver Productos" */
        .link-productos {
...
<body>
    <div class="form-container">
        ...
        <form action="../config/insertar.php" method="post">
            ...
            <input type="number" id="precio" step="0.01" name="precio" required><br>
            <label for="stock">Stock:</label>
            <input type="number" id="stock" name="stock" required><br>
            <button type="submit">Agregar Producto</button>
        </form>
    </div>
    <a href="listar_productos.php" class="link-productos">Ver Productos</a>
</body>
</html>